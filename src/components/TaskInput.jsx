    ...
    return (
        <section className='absolute w-full flex flex-col justify-center items-center gap-5 mt-20 ' >
            ...
            <div className='flex gap-5 mt-5' >
                <input type="text" placeholder='Task Title' value={title} onChange={(e) => setTitle(e.target.value)} className='focus:outline-none border-2 rounded  border-slate-400 hover:border-slate-500 break-words' />
            ...
            <div className='flex flex-row justify-center items-center gap-3'>
                <textarea placeholder='Task Description' value={description} onChange={(e) => setDescription(e.target.value)} rows={4}
                    className='w-[20rem] border-2 focus:outline-none  border-slate-400 hover:border-slate-500 rounded break-words '></textarea>
